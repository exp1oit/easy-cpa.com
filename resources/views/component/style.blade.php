<!-- Google Fonts -->
  ...
  <!-- Favicons -->
  <link rel="shortcut icon" href="https://deothemes.com/envato/margin/html/img/favicon.ico">
  <link rel="apple-touch-icon" href="https://deothemes.com/envato/margin/html/img/apple-touch-icon.png">
  ...
  <style type="text/css">
    ...
    :root a[href*="/amigo-browser.ru"][target="_blank"],
    ...
    :root a[href*="down-news-games.ru"],
    ...
    :root a[href^="http://amigodistrib.ru/dkit-hps/"],
    ...
    :root [id*="MarketGid"],
    :root [id*="ScriptRoot"],
    :root a[href="http://track.freemmo2017.com/"],
    ...
    :root a[href*="verismediya.ru/sb/clk/"],
    :root a[href*="tvkw.ru"],
    :root div[id^="dfp-ad-"],
    ...
    :root #overlayvideo[style^="position: fixed; top: 0px; left: 0px; background: rgba"][style*=" z-index"],
    ...
    :root [data-leadlink*="admitlead."][data-leadlink*="/sb/clk/"],
    :root [data-link*="amigo-browser.ru/dkit-"],
    ...
    :root a[href*="admitlead."][href*="/sb/clk/"],
    ...
    :root .serp-list+.serp-list>.serp-adv__head,
