                        ...
                        <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="solid"
                            ...
                            <li class="pcoded-hasmenu active pcoded-trigger" dropdown-icon="style1" subitem-icon="style1">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="active">
                                        <a href="https://colorlib.com//polygon/admindek/default/index.html" class="waves-effect waves-dark">
                                            <span class="pcoded-mtext">Default</span>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a href="https://colorlib.com//polygon/admindek/default/dashboard-crm.html"
                                            class="waves-effect waves-dark">
                                            <span class="pcoded-mtext">CRM</span>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a href="https://colorlib.com//polygon/admindek/default/dashboard-analytics.html"
                                            class="waves-effect waves-dark">
